...
<?php
	...
	<div class="col pb-5 pt-3" align="right " >
     ...
     <button  class="btn btn-sm btn-primary pull-left" data-toggle="modal" data-target="#myModal" style="width:20%" > <i class="fa fa-medkit">Nouveau médicament</i>   </button> &nbsp;
	 <button  class="btn btn-sm btn-warning pull-left" data-toggle="modal" data-target="#myModal1" style="width:20%" > <i class="fa fa-pencil">&nbsp; Modifier catégorie</i>  </button>
     <button  class="btn btn-sm btn-danger pull-left"  style="width:20%" > <i class="fa fa-trash">&nbsp;Supprimer catégorie</i>  </button>
